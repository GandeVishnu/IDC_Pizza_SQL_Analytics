...
I completed a hands-on mini-project analyzing IDC pizza dataset using **PostgreSQL**. This project helped me consolidate SQL fundamentals, including filtering, joins, aggregations, and data cleaning, while deriving actionable business insights.  
